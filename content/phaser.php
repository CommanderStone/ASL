...
<div class="w3-main w3-light-grey" >
  ...
  <div class="w3-container">
    <p><b style="font-size:25px;"><?php echo $pphase;?> </b> <span class="w3-badge w3-blue">A</span> = ATTACKER Action <span class="w3-badge w3-green">B</span> = BOTH SIDES Action <span class="w3-badge w3-red">D</span> = DEFENDER Action</p>
